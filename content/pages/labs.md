...
For required lab writeups, we suggest using the {{% resource_link "7bef2a1e-2fba-4c32-83df-6064a08f34d6" "OSA \"A\" Template" %}} for article submission. Alternatively, you can use the {{% resource_link "c02be85d-5113-4b6d-975a-e8ce843c94da" "American Institute of Physics templates" %}}. Moreover, you may decide to use the {{% resource_link "069619c1-75d9-4605-b6f7-258b748d49dc" "SPIE Templates" %}} or the {{% resource_link "19501a17-f0bb-443b-8e8b-d9a11a6f94a9" "IEEE Templates" %}}. Be sure to follow the style guide associated with the template you use.